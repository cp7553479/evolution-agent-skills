...
if (require.main === module) {
    ...
    if (!params.prompt) {
        console.error("Usage: node seedream.js --prompt <prompt> [--model <model>] [--size <size>] [--watermark <true/false>] [--output_format <format>] [--sequential_image_generation <mode>] [--tools <json>] [--optimize_prompt_options <json>]");
        process.exit(1);
    }
